...
public class ButtonsUI : MonoBehaviour
{
    ...
    [SerializeField] private Button _onHapticsButton;
    [SerializeField] private Button _offHapticsButton;
    ...
    {
        _onHapticsButton.gameObject.SetActive(false);
        _offHapticsButton.gameObject.SetActive(true);
        Clicked?.Invoke();
    }

    public void DisableHaptics()
    {
        _onHapticsButton.gameObject.SetActive(true);
        _offHapticsButton.gameObject.SetActive(false);
        Clicked?.Invoke();
    }
